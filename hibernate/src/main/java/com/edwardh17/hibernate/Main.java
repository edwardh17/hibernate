...
public class Main {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        insertarAuto("chevrolet", "2000", obtenerFecha("2005-05-05"), 18000, 1, sesion);
        insertarAuto("chevrolet", "1999", obtenerFecha("2005-01-01"), 15000, 2, sesion);
        insertarAuto("fiat", "2000", obtenerFecha("2005-01-06"), 14000, 1, sesion);
        insertarAuto("fiat", "2000", obtenerFecha("2004-01-09"), 14000, 3, sesion);
        insertarAuto("peugeot", "1998", obtenerFecha("2004-01-09"), 12000, 4, sesion);
        insertarAuto("peugeot", "1997", obtenerFecha("2003-05-06"), 95000, 4, sesion);
        insertarAuto("chevrolet", "1998", obtenerFecha("2006-01-01"), 8900, 2, sesion);
        insertarAuto("ford", "2002", obtenerFecha("2002-05-06"), 13500, 2, sesion);
        insertarAuto("ford", "2003", obtenerFecha("2002-09-09"), 16000, 1, sesion);
